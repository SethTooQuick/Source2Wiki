...
import filter_activator_mass_greaterIcon from '@site/static/img/Entities/steamvr/filter_activator_mass_greater.png';

<img src={filter_activator_mass_greaterIcon} alt="filter_activator_mass_greater icon" style={{height: '80px'}} />
