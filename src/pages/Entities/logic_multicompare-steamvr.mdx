...
import logic_multicompareIcon from '@site/static/img/Entities/steamvr/logic_multicompare.png';

<img src={logic_multicompareIcon} alt="logic_multicompare icon" style={{height: '80px'}} />
