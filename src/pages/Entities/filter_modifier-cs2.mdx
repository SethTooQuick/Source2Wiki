...
import filter_modifierIcon from '@site/static/img/Entities/cs2/filter_modifier.png';

<img src={filter_modifierIcon} alt="filter_modifier icon" style={{height: '80px'}} />

Point Entity

A filter that filters entities by active modifiers applied to them
...
- **Modifier Name** (`filtermodifier`) \<`String`\>\
The name of the modifier to filter entities by
