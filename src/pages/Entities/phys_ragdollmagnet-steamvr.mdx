...
import phys_ragdollmagnetIcon from '@site/static/img/Entities/steamvr/phys_ragdollmagnet.png';

<img src={phys_ragdollmagnetIcon} alt="phys_ragdollmagnet icon" style={{height: '80px'}} />
