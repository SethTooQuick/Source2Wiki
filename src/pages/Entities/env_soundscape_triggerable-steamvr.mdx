...
import env_soundscape_triggerableIcon from '@site/static/img/Entities/steamvr/env_soundscape_triggerable.png';

<img src={env_soundscape_triggerableIcon} alt="env_soundscape_triggerable icon" style={{height: '80px'}} />
