...
import env_soundscape_proxyIcon from '@site/static/img/Entities/steamvr/env_soundscape_proxy.png';

<img src={env_soundscape_proxyIcon} alt="env_soundscape_proxy icon" style={{height: '80px'}} />
