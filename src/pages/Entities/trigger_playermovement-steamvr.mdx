...
import trigger_playermovementIcon from '@site/static/img/Entities/steamvr/trigger_playermovement.png';

<img src={trigger_playermovementIcon} alt="trigger_playermovement icon" style={{height: '80px'}} />
...
- **Spawnflags** (`spawnflags`) \<`Flags`\>
  - (OBSOLETE, Uncheck me) 
  - Disable auto player movement 
  - Auto-duck while in trigger 
  - Auto-walk while in trigger 
  - Disable jump while in trigger 
