...
- **Disappear Min Distance** (`DisappearMinDist`) \<`Integer`\>\
Distance at which these brushes should starting fade out.

- **Disappear Max Distance** (`DisappearMaxDist`) \<`Integer`\>\
Distance at which these brushes should be completely faded out.
