...
import info_targetIcon from '@site/static/img/Entities/steamvr/info_target.png';

<img src={info_targetIcon} alt="info_target icon" style={{height: '80px'}} />
...
- **Spawnflags** (`spawnflags`) \<`Flags`\>
  - Transmit to client (respect PVS) 
  - Always transmit to client (ignore PVS) 
