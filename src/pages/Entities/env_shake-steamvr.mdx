...
import env_shakeIcon from '@site/static/img/Entities/steamvr/env_shake.png';

<img src={env_shakeIcon} alt="env_shake icon" style={{height: '80px'}} />
...
- **Limit to entity** (`limittoentity`) \<`TargetDestination`\>\
Limit the shake to entity or entities matching the name or class name.
