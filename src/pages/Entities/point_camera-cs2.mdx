...
- **HLTV Usable** (`hltvUsable`) \<`Boolean`\>
...
- SetDOFNearBlurry \<`Float`\>\
Set DOF Near Blurry Range.

- SetDOFNearCrisp \<`Float`\>\
Set DOF Near Crisp Range.

- SetDOFFarCrisp \<`Float`\>\
Set DOF Far Crisp Range.

- SetDOFFarBlurry \<`Float`\>\
Set DOF Far Blurry Range.

- SetDOFTiltToGround \<`Float`\>\
Set DOF Tilt to Ground Amount (0..1).
