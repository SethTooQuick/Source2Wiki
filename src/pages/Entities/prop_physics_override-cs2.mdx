...
- **Prop Data Override** (`propdata_override`) \<`String`\>\
Prop Data names defined in propdata.vdata are typically defined in the VMDL used by this prop. For prototyping, this allows you to select a specific one and ignore the name in the VMDL.
