...
import env_physexplosionIcon from '@site/static/img/Entities/cs2/env_physexplosion.png';
...
If specified, amount of damage to deal. If unspecified, magnitude is used as the damage.
