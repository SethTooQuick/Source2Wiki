...
import logic_npc_counter_aabbIcon from '@site/static/img/Entities/steamvr/logic_npc_counter_aabb.png';

<img src={logic_npc_counter_aabbIcon} alt="logic_npc_counter_aabb icon" style={{height: '80px'}} />
