...
import logic_npc_counter_radiusIcon from '@site/static/img/Entities/steamvr/logic_npc_counter_radius.png';

<img src={logic_npc_counter_radiusIcon} alt="logic_npc_counter_radius icon" style={{height: '80px'}} />
