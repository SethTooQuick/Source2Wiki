...
import snd_event_paramIcon from '@site/static/img/Entities/steamvr/snd_event_param.png';

<img src={snd_event_paramIcon} alt="snd_event_param icon" style={{height: '80px'}} />
