...
import env_skyIcon from '@site/static/img/Entities/cs2/env_sky.png';

<img src={env_skyIcon} alt="env_sky icon" style={{height: '80px'}} />
...
- **Skybox Material** (`skyname`) \<`Resource`\>

- **Sky Tint Color** (`tint_color`) \<`Color255`\>\
Tint the skybox
