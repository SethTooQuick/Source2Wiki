...
import info_npc_spawn_destinationIcon from '@site/static/img/Entities/steamvr/info_npc_spawn_destination.png';

<img src={info_npc_spawn_destinationIcon} alt="info_npc_spawn_destination icon" style={{height: '80px'}} />
...
- **New NPC Name** (`RenameNPC`) \<`TargetDestination`\>\
