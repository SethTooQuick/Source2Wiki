...
import info_world_layerIcon from '@site/static/img/Entities/steamvr/info_world_layer.png';

<img src={info_world_layerIcon} alt="info_world_layer icon" style={{height: '80px'}} />
