...
import snd_event_orientedboxIcon from '@site/static/img/Entities/cs2/snd_event_orientedbox.png';

<img src={snd_event_orientedboxIcon} alt="snd_event_orientedbox icon" style={{height: '80px'}} />
