...
import snd_opvar_set_obbIcon from '@site/static/img/Entities/steamvr/snd_opvar_set_obb.png';

<img src={snd_opvar_set_obbIcon} alt="snd_opvar_set_obb icon" style={{height: '80px'}} />
