...
import point_soundeventIcon from '@site/static/img/Entities/cs2/point_soundevent.png';

<img src={point_soundeventIcon} alt="point_soundevent icon" style={{height: '80px'}} />
