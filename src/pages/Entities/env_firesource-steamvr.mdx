...
import env_firesourceIcon from '@site/static/img/Entities/steamvr/env_firesource.png';

<img src={env_firesourceIcon} alt="env_firesource icon" style={{height: '80px'}} />
