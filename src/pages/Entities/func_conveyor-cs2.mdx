...
- **Models** (`conveyor_models`) \<`TargetDestination`\>\
...
- **Conveyor Speed, , in inches / second.** (`speed`) \<`Float`\>

- **Transition Duration (seconds)** (`transition_duration`) \<`Float`\>\
How long it will take to transition to the new speed.
...
- SetSpeed \<`Float`\>\
Set the speed in inches per second,

- SetTransitionDuration \<`Float`\>\
Set the duration in seconds to transition to the new speed,
