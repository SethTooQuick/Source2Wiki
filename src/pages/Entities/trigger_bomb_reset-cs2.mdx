...
import trigger_bomb_resetIcon from '@site/static/img/Entities/cs2/trigger_bomb_reset.png';

<img src={trigger_bomb_resetIcon} alt="trigger_bomb_reset icon" style={{height: '80px'}} />
