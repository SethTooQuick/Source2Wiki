...
- **Depth of Field Enabled** (`dof_enabled`) \<`Boolean`\>

- **Depth of Field Near Blurry Distance** (`dof_near_blurry`) \<`Float`\>

- **Depth of Field Near Crisp Distance** (`dof_near_crisp`) \<`Float`\>

- **Depth of Field Far Crisp Distance** (`dof_far_crisp`) \<`Float`\>

- **Depth of Field Far Blurry Distance** (`dof_far_blurry`) \<`Float`\>

- **Depth of Field Tilt Lens to Align With Ground Plane** (`dof_tilt_to_ground`) \<`Float`\>
