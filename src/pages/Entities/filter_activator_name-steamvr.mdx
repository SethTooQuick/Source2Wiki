...
import filter_activator_nameIcon from '@site/static/img/Entities/steamvr/filter_activator_name.png';

<img src={filter_activator_nameIcon} alt="filter_activator_name icon" style={{height: '80px'}} />
...
- **Filter Name** (`filtername`) \<`TargetDestination`\>\
