...
- **Exploitable by Player** (`ExploitableByPlayer`) \<`Choices`\>
  - Default 
  - Explosive 


- **Silent To Zombies** (`SilentToZombies`) \<`Boolean`\>\
Should this prop generate sounds that blind zombies can hear.
