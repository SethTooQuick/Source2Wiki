...
- **Attachment 1** (`attach1`) \<`TargetDestination`\>\
First entity.  Must be a single entity unless "Support multiple entities with same name" is specified.

- **Attachment 2** (`attach2`) \<`TargetDestination`\>\
Second entity.  Must be a single entity unless "Support multiple entities with same name" is specified.
