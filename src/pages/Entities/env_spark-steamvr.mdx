...
import env_sparkIcon from '@site/static/img/Entities/steamvr/env_spark.png';

<img src={env_sparkIcon} alt="env_spark icon" style={{height: '80px'}} />
...
- **Spark Type** (`SparkType`) \<`Choices`\>\
What Type of Spark Effect
  - Electrical 
  - Metal 
  - base 
