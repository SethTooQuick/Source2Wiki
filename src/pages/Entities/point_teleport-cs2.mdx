...
- **Entity To Teleport** (`target`) \<`TargetDestination`\>\
Name of the entity that will be teleported.

- **Spawnflags** (`spawnflags`) \<`Flags`\>
  - Teleport Home 
  - Into Duck (episodic) 
  - Change View Direction (VR) 


- **Teleport Parented Ents** (`teleport_parented_entities`) \<`Boolean`\>

- **Teleport Uses Current Rotation** (`teleport_use_current_angle`) \<`Boolean`\>
...
- TeleportEntity \<`TargetDestination`\>\
...
- TeleportEntityToCurrentPos \<`Void`\>\
Teleport the entity specified by the parameter override to wherever the point_teleport entity is currently. The Teleport input teleports to the current position of the point_teleport
