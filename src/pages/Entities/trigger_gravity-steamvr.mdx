...
import trigger_gravityIcon from '@site/static/img/Entities/steamvr/trigger_gravity.png';

<img src={trigger_gravityIcon} alt="trigger_gravity icon" style={{height: '80px'}} />
