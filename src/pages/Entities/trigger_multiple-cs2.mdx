...
import trigger_multipleIcon from '@site/static/img/Entities/cs2/trigger_multiple.png';

<img src={trigger_multipleIcon} alt="trigger_multiple icon" style={{height: '80px'}} />
