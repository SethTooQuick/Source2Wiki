...
- FlyAway \<`Void`\>\
Forces the bird to fly to a nearby crow flyto hint node.

- FlyPath \<`String`\>\
Forces the bird to fly the path, starting with the specified path corner. Bird must have line of sight to the specified path corner.

- FlyToHint \<`String`\>\
Forces the bird to fly to the specific crow flyto hint node.
