...
- **Bomb Mount Target** (`bomb_mount_target`) \<`String`\>

- **Bomb Site** (`bomb_site_designation`) \<`Choices`\>
  - A 
  - B 
...
- BombExplode \<`Void`\>\
Fires when C4 explodes

- BombPlanted \<`Void`\>\
Fires when a C4 is planted

- BombDefused \<`Void`\>\
Fires when a C4 is defused
