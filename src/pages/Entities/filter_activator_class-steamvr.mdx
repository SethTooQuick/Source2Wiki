...
import filter_activator_classIcon from '@site/static/img/Entities/steamvr/filter_activator_class.png';

<img src={filter_activator_classIcon} alt="filter_activator_class icon" style={{height: '80px'}} />
