...
import snd_event_sphereIcon from '@site/static/img/Entities/cs2/snd_event_sphere.png';

<img src={snd_event_sphereIcon} alt="snd_event_sphere icon" style={{height: '80px'}} />
...
- **Entity Index Selection** (`entityIndexSelection`) \<`Choices`\>
  - Use World Index 
  - Use Entity Index 


- **Radius** (`radius`) \<`Float`\>\
Size of soundevent sphere
