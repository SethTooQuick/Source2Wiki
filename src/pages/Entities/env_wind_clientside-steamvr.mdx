...
import env_wind_clientsideIcon from '@site/static/img/Entities/steamvr/env_wind_clientside.png';

<img src={env_wind_clientsideIcon} alt="env_wind_clientside icon" style={{height: '80px'}} />
