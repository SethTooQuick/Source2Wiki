...
import snd_soundscape_triggerableIcon from '@site/static/img/Entities/steamvr/snd_soundscape_triggerable.png';

<img src={snd_soundscape_triggerableIcon} alt="snd_soundscape_triggerable icon" style={{height: '80px'}} />
