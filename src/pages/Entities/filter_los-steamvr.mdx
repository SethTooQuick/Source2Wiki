...
import filter_losIcon from '@site/static/img/Entities/steamvr/filter_los.png';

<img src={filter_losIcon} alt="filter_los icon" style={{height: '80px'}} />

Point Entity

A filter that filters a potential entity by line of sight from the origin of the filter.
