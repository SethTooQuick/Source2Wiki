...
import snd_event_pointIcon from '@site/static/img/Entities/cs2/snd_event_point.png';

<img src={snd_event_pointIcon} alt="snd_event_point icon" style={{height: '80px'}} />
