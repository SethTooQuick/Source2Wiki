...
import env_fog_controllerIcon from '@site/static/img/Entities/steamvr/env_fog_controller.png';

<img src={env_fog_controllerIcon} alt="env_fog_controller icon" style={{height: '80px'}} />
