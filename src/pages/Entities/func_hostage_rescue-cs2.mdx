...
import func_hostage_rescueIcon from '@site/static/img/Entities/cs2/func_hostage_rescue.png';

<img src={func_hostage_rescueIcon} alt="func_hostage_rescue icon" style={{height: '80px'}} />
