...
import trigger_hostage_resetIcon from '@site/static/img/Entities/cs2/trigger_hostage_reset.png';

<img src={trigger_hostage_resetIcon} alt="trigger_hostage_reset icon" style={{height: '80px'}} />
