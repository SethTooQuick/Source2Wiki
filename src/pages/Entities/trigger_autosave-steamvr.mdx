...
import trigger_autosaveIcon from '@site/static/img/Entities/steamvr/trigger_autosave.png';

<img src={trigger_autosaveIcon} alt="trigger_autosave icon" style={{height: '80px'}} />
