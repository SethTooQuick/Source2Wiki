...
An entity to control the fog in the map.
...
- **Fog Name** (`FogName`) \<`TargetDestination`\>\
The name of the fog entity associated with this volume.

- **Postprocess Name** (`PostProcessName`) \<`TargetDestination`\>\
The name of the postprocess entity associated with this volume.

- **ColorCorrection Name** (`ColorCorrectionName`) \<`TargetDestination`\>\
