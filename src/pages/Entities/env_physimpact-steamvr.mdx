...
import env_physimpactIcon from '@site/static/img/Entities/steamvr/env_physimpact.png';

<img src={env_physimpactIcon} alt="env_physimpact icon" style={{height: '80px'}} />
...
- **Point to Entity** (`directionentityname`) \<`TargetDestination`\>\
...
- **Spawnflags** (`spawnflags`) \<`Flags`\>
  ...
  - Infinite Length 
  - Ignore Mass 
  - Ignore Surface Normal When Applying Force 
