...
import env_rotorshooterIcon from '@site/static/img/Entities/steamvr/env_rotorshooter.png';

<img src={env_rotorshooterIcon} alt="env_rotorshooter icon" style={{height: '80px'}} />
