...
import point_nav_walkableIcon from '@site/static/img/Entities/cs2/point_nav_walkable.png';

<img src={point_nav_walkableIcon} alt="point_nav_walkable icon" style={{height: '80px'}} />
