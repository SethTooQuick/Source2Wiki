...
- **Enable Offscreen Indicator** (`enable_offscreen_indicator`) \<`Boolean`\>

- **Horizontal Align** (`horizontal_align`) \<`Choices`\>
  - Left 
  - Center 
  - Right 


- **Vertical Align** (`vertical_align`) \<`Choices`\>
  - Bottom 
  - Center 
  - Top 
...
Set the text to an integer value.
