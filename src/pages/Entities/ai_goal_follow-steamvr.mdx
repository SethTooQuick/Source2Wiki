...
import ai_goal_followIcon from '@site/static/img/Entities/steamvr/ai_goal_follow.png';

<img src={ai_goal_followIcon} alt="ai_goal_follow icon" style={{height: '80px'}} />
