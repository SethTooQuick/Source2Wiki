...
import snd_event_alignedboxIcon from '@site/static/img/Entities/cs2/snd_event_alignedbox.png';

<img src={snd_event_alignedboxIcon} alt="snd_event_alignedbox icon" style={{height: '80px'}} />
