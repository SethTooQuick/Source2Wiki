...
import env_cubemap_fogIcon from '@site/static/img/Entities/steamvr/env_cubemap_fog.png';
...
- **Cubemap Texture** (`cubemapfogtexture`) \<`Resource`\>

- **Cubemap LOD (mip) Bias** (`cubemapfoglodbiase`) \<`Float`\>\
Adjust how quickly the cubemap blurs out into the distance
