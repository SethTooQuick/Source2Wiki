...
import trigger_soundscapeIcon from '@site/static/img/Entities/steamvr/trigger_soundscape.png';

<img src={trigger_soundscapeIcon} alt="trigger_soundscape icon" style={{height: '80px'}} />
...
- **Soundscape** (`soundscape`) \<`TargetSource`\>
