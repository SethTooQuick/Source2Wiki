...
import trigger_removeIcon from '@site/static/img/Entities/steamvr/trigger_remove.png';

<img src={trigger_removeIcon} alt="trigger_remove icon" style={{height: '80px'}} />
