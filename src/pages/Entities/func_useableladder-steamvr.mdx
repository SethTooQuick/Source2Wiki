...
- **End** (`point1`) \<`LocalPoint`\>\
Ladder end point.

- **Start Disabled** (`StartDisabled`) \<`Boolean`\>

- **Auto Ride Speed** (`AutoRideSpeed`) \<`Float`\>

- **Surface properties (optional)** (`ladderSurfaceProperties`) \<`String`\>
...
- OnPlayerGotOnLadder \<`Void`\>\
Fired whenever a player gets on this ladder.

- OnPlayerGotOffLadder \<`Void`\>\
