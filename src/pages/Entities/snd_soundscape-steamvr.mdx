...
import snd_soundscapeIcon from '@site/static/img/Entities/steamvr/snd_soundscape.png';

<img src={snd_soundscapeIcon} alt="snd_soundscape icon" style={{height: '80px'}} />
