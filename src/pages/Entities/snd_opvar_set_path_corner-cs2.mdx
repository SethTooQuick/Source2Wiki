...
import snd_opvar_set_path_cornerIcon from '@site/static/img/Entities/cs2/snd_opvar_set_path_corner.png';

<img src={snd_opvar_set_path_cornerIcon} alt="snd_opvar_set_path_corner icon" style={{height: '80px'}} />
...
- **Path Corner Starting Entity** (`pathCornerEntityName`) \<`TargetDestination`\>\
The name of the entity that is at the start of the path
